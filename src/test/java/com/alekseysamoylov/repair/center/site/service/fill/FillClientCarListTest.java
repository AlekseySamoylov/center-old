...
public class FillClientCarListTest {
    @Autowired
    @Qualifier("fillClientCarList")
    FillWebList<WebElement> fillWebList;

    @Test
    public void createOrderListTest() {
        Assert.assertEquals("Acura CL A456AA 159", fillWebList.getFilledWebList((long)3).getWebList().get(0).getName());
    }
}
