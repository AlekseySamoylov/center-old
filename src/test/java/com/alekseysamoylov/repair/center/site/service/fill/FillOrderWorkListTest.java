...
public class FillOrderWorkListTest {
    @Autowired
    @Qualifier("fillOrderWorkList")
    FillWebList<WebElement> fillWebList;

    @Test
    public void createOrderListTest() {
        Assert.assertEquals("Замена шаровой", fillWebList.getFilledWebList(1L).getWebList().get(0).getName());
    }
}
