...
public class CarModelDaoTest {
    ...
    private CarModel oldEntity;
    private CarModel newEntity;

    @Autowired
    @Qualifier("carModelDaoImpl")
    private EntityDao<CarModel> entityDao;
    ...
    public void before() {
        ...
        newEntity = createBefore.carModel;
    ...
    @Test
    public void get() {
        Assert.assertEquals("CL", entityDao.get((long) 1).getName());
    }

    @Test
    public void findConcrete() {
        List<CarModel> list = entityDao.find("CL");
        Assert.assertEquals("CL", list.get(0).getName());
    }
